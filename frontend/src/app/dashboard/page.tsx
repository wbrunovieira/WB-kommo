    ...
    >
      ...
      <main style={{ padding: '48px 32px', maxWidth: '900px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '16px' }}>
          ...
          <InfoCard label="Tenant ID" value={user.tenantId} />
          <InfoCard label="Função" value={roleLabel[user.role] ?? user.role} accent />
        </div>
        ...
        >
          ...
          <p style={{ margin: 0, fontSize: '14px' }}>
            Dashboard em construção — leads, pipelines e muito mais em breve.
          </p>
        </div>
      </main>
    </div>
